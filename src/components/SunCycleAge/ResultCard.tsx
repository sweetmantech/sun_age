...
const ResultCard: React.FC<ResultCardProps> = ({
  ...
  <div aria-live="polite" className="flex flex-col items-center justify-center min-h-[60vh] w-full px-4 transition-opacity duration-500 opacity-100">
    <div className="bg-white/80 dark:bg-black/40 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-8 max-w-md w-full flex flex-col items-center space-y-6 relative">
      ...
      <Image
        ...
        width={96}
        height={96}
        className="w-24 h-24 object-contain mb-2 drop-shadow-xl opacity-90"
        style={{ filter: 'drop-shadow(0 0 16px #fff8) grayscale(0.2)' }}
        priority
      />
