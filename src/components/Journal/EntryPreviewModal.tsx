...
export const EntryPreviewModal: React.FC<EntryPreviewModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      {/* Modal card */}
      <div
        className="relative z-10 w-full max-w-md h-[75vh] flex flex-col"
      ...
      >
        <div className="backdrop-blur-md bg-[#FFFCF2]/50 border border-gray-200 w-full h-full flex flex-col rounded-none" style={{ borderRadius: 0 }}>
          ...
          <div className="flex-1 overflow-y-auto pb-2" style={{ color: '#222222', paddingLeft: 32, paddingRight: 32 }}>
            <div className="font-serif text-[18px] font-normal leading-[24px] tracking-tight whitespace-pre-line" style={{ letterSpacing: '-0.03em', color: '#222222' }}>
              {previewText}
            </div>
